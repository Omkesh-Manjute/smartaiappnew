...
const HeatmapPage = () => {
  ...
  // Get weak subjects for practice suggestions
  const getWeakSubjects = () => {
    return subjects
      .map((s) => ({ subject: s, mastery: getSubjectMastery(s.id) }))
  ...
  const getPracticeSuggestions = () => {
    ...
    suggestions.push({
      text: 'Improve pronunciation with Voice Practice',
      action: () => navigate('/student/voice'),
      icon: Mic,
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">⚠️ Weak</p>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <CardContent>
                {practiceSuggestions.length > 0 ? (
                    ...
                    {practiceSuggestions.map((suggestion, index) => {
                      ...
                      return (
                        <Button
                          ...
                          className={`w-full justify-start text-left h-auto py-3 ${suggestion.color} border`}
                        >
                  ...
                  <p className="text-sm text-gray-500 text-center py-4">
                    Great job! Complete some tests to get personalized suggestions.
                  </p>
                )}
              </CardContent>
            </Card>
